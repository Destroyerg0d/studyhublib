...
const Verification = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Front file:', aadharFront.name, 'Size:', aadharFront.size);
      console.log('Back file:', aadharBack.name, 'Size:', aadharBack.size);
      
      // Upload Aadhar front
      const frontFileName = `${profile.id}/aadhar_front_${Date.now()}.${aadharFront.name.split('.').pop()}`;
      console.log('Uploading front file to:', frontFileName);
      ...
      console.log('Uploading back file to:', backFileName);
      ...
      console.log('Generated URLs:', { 
        front: frontUrl.publicUrl, 
        back: backUrl.publicUrl 
      });
