-- First, let's delete existing plans and create new ones with updated structure and pricing
DELETE FROM plans;

-- Insert new plans with updated structure and pricing based on the image
-- Full Day (6 AM - 10 PM) - ₹1,000/month (using 'day' type to match existing constraint)
...
-- Morning Shift (6 AM - 3 PM) - ₹600/month (new type 'morning')
...
-- Evening Shift (3 PM - 10 PM) - ₹600/month (new type 'evening')
...
-- Night Shift (10 PM - 6 AM) - ₹1,200/month (existing type 'night')
...
-- Full Shift (24/7) - ₹2,000/month (using existing '24/7' type)
